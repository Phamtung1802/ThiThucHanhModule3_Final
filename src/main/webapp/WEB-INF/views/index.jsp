...
<body>
<header>
    <H1 class="container col-12 text-center"> Product</H1>
</header>
<!------------------------------------------------------------------HEADER----------------------------------------------->
        ...
        <div class="col-12 row container bg-white" style="margin-left: 12px">
            ...
            <table class="table text-center col-sm-8 col-md-8 col-lg-8">
                ...
                <tr class="" style="width:100%">
                    ...
                    <th scope="col" style="width:24%; max-width:24%;">Image</th>
                    <th scope="col" style="width:12%">Line</th>
                            ...
                            <div class=\"modal-content\">
                              ...
                              <div class=\"modal-body\">
                                 <form method=\"post\" action=\"products\">
                                     ...
                                     <input readonly class=\"form-control\" name=\"brand\" style=\"width:100%\" type=\"text\" value=\"${product.getProductPrice()}\"><br>
                                     <input readonly class=\"form-control\" name=\"price\" style=\"width:100%\" type=\"number\" value=\"${product.getProductPrice()}\"><br>
                                     <input readonly class=\"form-control\" name=\"image\" style=\"width:100%\" type=\"text\" value=\" ${product.getProductQuantity()}\"><br>
                                    <input readonly class=\"form-control\" name=\"line\" style=\"width:100%\" type=\"text\" value=\"${product.getProductColor()}\"><br>
                                    <input readonly class=\"form-control\" name=\"line\" style=\"width:100%\" type=\"text\" value=\"${product.getProductCategory()}\"><br>
